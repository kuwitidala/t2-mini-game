...
// маскот сцены
  ...
  function setMascotPose(poseNumber) {
    ...
    mascotEl.classList.remove("mascot--pose-1", "mascot--pose-2", "mascot--pose-3");
    mascotEl.classList.add("mascot--pose-" + poseNumber);

    mascotBubble.classList.remove("bubble--pose-1", "bubble--pose-2", "bubble--pose-3");
    mascotBubble.classList.add("bubble--pose-" + poseNumber);
  }
  ...
  function startIntroSequence() {
    ...
    playSequence(
      [
        { text: "Привет! Похоже, на станции Т2 что-то пошло не так - сеть работает нестабильно.", position: "right" },
        { text: "Смотри: вышка, дом со щитком и значок радиооборудования над ним. Что-то из этого барахлит. Неисправное оборудование обозначено розовым на карте", position: "right" },
        { text: "Начни с вышки или с радиооборудования, я буду рядом, если понадобится помощь. Радиоборудование обозначено значком Wi-FI над домом", position: "right" }
      ],
